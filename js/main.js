...
function(
	...
	var ogGeneralServiceURL = "//services.kgs.ku.edu/arcgis8/rest/services/oilgas/oilgas_general/MapServer";
	...
	var naip2017Layer = new ImageryLayer( {url:"//services.kgs.ku.edu/arcgis7/rest/services/IMAGERY_STATEWIDE/FSA_NAIP_2017_Color/ImageServer", id:"2017", format:"jpg", visible:false} );
	var naip2015Layer = new ImageryLayer( {url:"//services.kgs.ku.edu/arcgis7/rest/services/IMAGERY_STATEWIDE/FSA_NAIP_2015_Color/ImageServer", id:"2015", format:"jpg", visible:false} );
	var naip2014Layer = new ImageryLayer( {url:"//services.kgs.ku.edu/arcgis7/rest/services/IMAGERY_STATEWIDE/FSA_NAIP_2014_Color/ImageServer", id:"2014", format:"jpg", visible:false} );
	var naip2012Layer = new ImageryLayer( {url:"//services.kgs.ku.edu/arcgis7/rest/services/IMAGERY_STATEWIDE/FSA_NAIP_2012_Color/ImageServer", id:"2012", format:"jpg", visible:false} );
	var naip2010Layer = new ImageryLayer( {url:"//services.kgs.ku.edu/arcgis7/rest/services/IMAGERY_STATEWIDE/FSA_NAIP_2010_Color/ImageServer", id:"2010", format:"jpg", visible:false} );
	var naip2008Layer = new ImageryLayer( {url:"//services.kgs.ku.edu/arcgis7/rest/services/IMAGERY_STATEWIDE/FSA_NAIP_2008_Color/ImageServer", id:"2008", format:"jpg", visible:false} );
    ...
    function createDialogs() {
		...
		var probDia = "<table><tr><td class='find-label'>Message:</td><td><textarea rows='4' cols='25' id='prob-msg' placeholder='Feature ID is automatically included. Please include email or phone number in case more information is needed.'></textarea></td></tr>";
